...
import ManageClassProfilesContent from '../components/ui/ManageClassProfilesContent';

export default function ManageClassProfilesPage() {
  return (
